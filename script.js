...
(() => {
  ...
  /* ======================================================================
     ...
     ====================================================================== */
  if (isTouch) {
    // Scoped to actual controls (buttons, photos) rather than the whole page,
    // so scrolling the page doesn't spam ripples that were never meant for it.
...
On 27 May, I told you how I felt, and I meant every word of it. I'm not writing this to ask if anything's changed, or to nudge you toward an answer — I just wanted you to have this, without any pressure attached.
